  ...
  return (
    ...
    >
      <div className="text-center px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 2xl:px-40">
        <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-black mb-6 sm:mb-8 drop-shadow-2xl text-blue-600 tracking-[0.2em] font-['Montserrat']">
          KELVIN MOMO
        </h1>
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-blue-500 text-center font-black drop-shadow-lg font-['Montserrat']">
          MR PRIVATE SCHOOL PIANO • THE PIANO KING
        </p>
      </div>
      <div className="absolute xs:bottom-12 bottom-4 w-full flex justify-center items-center">
        <a href="#about">
          <div className="border-none flex justify-center items-center p-2 mb-4">
            <div
              ref={arrowRef}
              className="w-0 h-0 border-l-[12px] border-r-[12px] border-t-[24px] border-l-transparent border-r-transparent border-t-blue-500"
            />
          </div>
          <p className="text-sm text-gray-500">Click to scroll down</p>
        </a>
      </div>
    </section>
  );
